...
// Connect wallet and authenticate
router.post('/connect', validate(authController.connectWalletSchema), authController.connectWallet);

// Refresh access token
router.post('/refresh', validate(authController.refreshTokenSchema), authController.refreshToken);
